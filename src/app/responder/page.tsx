...
const ACTIVE_REPORTS = [
  { id: "REP-001", reporterName: "نسيبة عصبان ", avatarUrl: "/2.png", type: "إغماء مفاجئ", location: "المكلا - فوة - المساكن", medicalProfile: { age: 21, gender: "أنثى", bloodType: "O+", chronicDiseases: ["هبوط سكر"], medications: ["فيتامينات"], allergies: ["البنسلين"], phone: "0533112233" } },
  { id: "REP-002", reporterName: "منى باحسين", avatarUrl: "/11.png", type: "أزمة تنفسية", location: "المكلا - الديس - شارع الغويزي", medicalProfile: { age: 20, gender: "أنثى", bloodType: "A-", chronicDiseases: ["الربو"], medications: ["فنتولين"], allergies: ["الغبار"], phone: "0544223344" } },
  { id: "REP-003", reporterName: "نجد مسيعان", avatarUrl: "/3.png", type: "نزيف حاد", location: "المكلا - روكب", medicalProfile: { age: 22, gender: "أنثى", bloodType: "B+", chronicDiseases: ["لا يوجد"], medications: ["لا يوجد"], allergies: ["لا يوجد"], phone: "0555334455" } },
  { id: "REP-004", reporterName: "نور العمودي", avatarUrl: "/00.jpg", type: "تشنجات", location: "المكلا - بويش", medicalProfile: { age: 19, gender: "أنثى", bloodType: "AB+", chronicDiseases: ["صرع"], medications: ["إيبانوتين"], allergies: ["لا يوجد"], phone: "0566445566" } },
  { id: "REP-005", reporterName: "رغد بلعفير", avatarUrl: "/5.png", type: "حادث سير", location: "المكلا - شارع الستين", medicalProfile: { age: 23, gender: "أنثى", bloodType: "O-", chronicDiseases: ["لا يوجد"], medications: ["لا يوجد"], allergies: ["لا يوجد"], phone: "0577556677" } },
  { id: "REP-006", reporterName: "خلود بن ثابت", avatarUrl: "/6.png", type: "ألم في الصدر", location: "المكلا - الشرج", medicalProfile: { age: 21, gender: "أنثى", bloodType: "A+", chronicDiseases: ["اشتباه صمام"], medications: ["أسبرين"], allergies: ["لا يوجد"], phone: "0588667788" } },
  { id: "REP-007", reporterName: "عائشة مرعي", avatarUrl: "/7.png", type: "هبوط حاد", location: "المكلا - جول مسحة", medicalProfile: { age: 22, gender: "أنثى", bloodType: "O+", chronicDiseases: ["لا يوجد"], medications: ["لا يوجد"], allergies: ["مأكولات بحرية"], phone: "0599778899" } },
  { id: "REP-008", reporterName: "نور باعباد", avatarUrl: "/8.png", type: "كسر مضاعف", location: "المكلا - امبيخة", medicalProfile: { age: 20, gender: "أنثى", bloodType: "B-", chronicDiseases: ["لا يوجد"], medications: ["لا يوجد"], allergies: ["براسيتامول"], phone: "0500112233" } },
  { id: "REP-009", reporterName: "منية باكرمان", avatarUrl: "/9.png", type: "صدمة حرارية", location: "المكلا - بروم", medicalProfile: { age: 19, gender: "أنثى", bloodType: "AB-", chronicDiseases: ["لا يوجد"], medications: ["لا يوجد"], allergies: ["لا يوجد"], phone: "0511223344" } },
  { id: "REP-010", reporterName: "هديل المنهالي", avatarUrl: "/10.png", type: "تسمم غذائي", location: "المكلا - غيل باوزير", medicalProfile: { age: 22, gender: "أنثى", bloodType: "A-", chronicDiseases: ["لا يوجد"], medications: ["لا يوجد"], allergies: ["لاكتوز"], phone: "0522334455" } },
  { id: "REP-011", reporterName: "ماريا الحيقي", avatarUrl: "/c2.jpg", type: "اختناق", location: "المكلا - الديس", medicalProfile: { age: 21, gender: "أنثى", bloodType: "O+", chronicDiseases: ["لا يوجد"], medications: ["لا يوجد"], allergies: ["لا يوجد"], phone: "0533445566" } },
];
        ...
        <div className="flex items-center gap-6">
          ...
          <div className="flex items-center gap-3">
             ...
             <div className="w-10 h-10 rounded-[10px] overflow-hidden border-2 border-slate-100 relative shadow-sm">
                <Image src="/1.png" alt="Admin" fill className="object-cover" />
             </div>
          </div>
        </div>
      </header>
